...
export default function AddCourseModal({ open, onClose, currentSemester, userId }: Props) {
  ...
  async function handleSubmit(ev: React.FormEvent) {
    ...
    setForm({
      name: "", course_code: "", category: "",
      credits: "3", semester: String(currentSemester),
      color: COURSE_COLORS[0]!,
    });
    setLoading(false);
    onClose();
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.75rem" }}>
          <div>
            <h2 style={{ fontSize: "1.25rem", fontWeight: 700, color: "#1c1917" }}>Add New Course</h2>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: "0.75rem", color: "#78716c" }}>
                {form.category || "Category"} · {form.credits} credits · Sem {form.semester}
              </p>
            </div>
          </div>
