...
export function TaskSkeleton() {
  return (
    <div className="clay-card" style={{ padding: "1.125rem 1.25rem", display: "flex", gap: "1rem", alignItems: "center" }}>
...
export function CourseSkeleton() {
  return (
    <div className="clay-card" style={{ padding: "1.5rem" }}>
      <div style={{ height: "4px", background: "var(--color-surface-200)", borderRadius: "4px", marginBottom: "1rem" }} />
      ...
      <Skeleton height="1px" width="100%" style={{ marginBottom: "0.875rem" }} />
